...
//@Component("personBean")  // Если не производится сканирование пакета, то и от аннотации Component смысла нет.
public class Person {
...
//    }
    ...
    // Если мы настраиваем конфиг java кодом без аннотаций, то все зависимости мы внедряем сами. Соответственно,
    // пропадает смысл использования данной аннотации.
    public Person(Pet pet) {  // Если мы настраиваем конфиг java кодом без аннотаций, то все зависимости мы внедряем
        // сами. Соответственно, пропадает смысл использования аннотации Qualifier.
        System.out.println("Использовался конструктор с аргументом");
        this.pet = pet;
    }
